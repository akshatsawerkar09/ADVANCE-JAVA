...
public class CustomerDaoImpl implements ICustomerDao {
	...
	public CustomerDaoImpl(String drvrClass, String url, String userName, String password)
	...
	public Customer authenticateUser(String email, String pwd) throws SQLException {
		...
		try (ResultSet rst = pst1.executeQuery()) {
			if (rst.next()) {
				customer = new Customer(rst.getInt(1), rst.getDouble(2), email, rst.getString(4), pwd, rst.getDate(6),
						rst.getString(7));
			}
		}
